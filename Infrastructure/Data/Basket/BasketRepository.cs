...
namespace Infrastructure.Data.Basket
{
    // Redis is a NoSql DB with <key, value> store
    // We will not use Entity Framework for basket, thus, we are not using the generic repo
